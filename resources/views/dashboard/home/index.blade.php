                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Sales <span>| All of time</span></h5>
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Product <span>| All of time</span></h5>
                    ...
                    <div class="col-xxl-4 col-xl-12">
                        ...
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Customers <span>| All of time</span></h5>
                    ...
                    <div class="col-12">
                        <div class="card top-selling overflow-auto">
                            ...
                            <div class="card-body pb-0">
                                <h5 class="card-title">Latest Products <span>| All</span></h5>
                                            ...
                                            <tr>
                                                <th scope="row"><a
                                                        href="{{ route('product.show', ['id' => $product->id]) }}"><img
                                                            src="{{ asset($product->cover_img) }}" alt=""></a></th>
                                                <td>
                                                    <p class="text-primary fw-bold">{{ $product->name }}</p>
                                                </td>
